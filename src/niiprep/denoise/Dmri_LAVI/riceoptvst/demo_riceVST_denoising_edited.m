...
percentNoise=8;   %% percent noise (sigma expressed as percentage value with respect to the maximum value of the original noise-free signal)
...
denMethod='bm3d';      %% BM4D (Maggioni & Foi)
...
Img_synt = double(zeros(513,513));

 Img_synt(1:171,1:171) = 0.2;
 Img_synt(1:171,172:342) = 0.2;
 Img_synt(1:171,343:513) = 0.2;
 Img_synt(172:342,1:171) = 0.2;
 Img_synt(172:342,172:342) = 0.2;
 Img_synt(172:342,343:513) = 0.6;
 Img_synt(343:513,1:171) = 0.6;
 Img_synt(343:513,172:342) = 0.6;
 Img_synt(343:513,343:513) = 0.6;
 
 nu = Img_synt*255;
 
    figure, imshow(mat2gray(nu),[]);
    figure, histogram(mat2gray(nu));
